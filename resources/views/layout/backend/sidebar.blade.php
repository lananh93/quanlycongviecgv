...
<ul class="sidebar-menu">
    ...
    <li class="treeview {!! (Request::is('admin/media*')) ? 'active' : '' !!}">
        ...
        <ul class="treeview-menu">
            <li class="{!! Request::is('admin/user') ? 'active' : '' !!}"><a href={!! route('admin::user::index') !!}><i class="fa fa-circle-o"></i> Tất cả quy định</a></li>
            <li class="{!! (Request::is('admin/user/addrule')) ? 'active' : '' !!}"><a href={!! route('admin::user::addrule') !!}><i class="fa fa-circle-o"></i> Thêm mới</a></li>
        </ul>
    </li>
