...
/**
 * Sends Messages using the email() function.
 *
 ...
 * due to limitations of PHP's internal email() function.  You'll get an
...
{
    /** Additional parameters to pass to email() */
    private $_extraParams = '-f%s';

    /** The event dispatcher from the plugin API */
    private $_eventDispatcher;

    /** An invoker that calls the email() function */
    private $_invoker;
    ...
    /**
     * Set the additional parameters used on the email() function.
     *
    ...
    /**
     * Get the additional parameters used on the email() function.
     *
     * This string is formatted for sprintf() where %s is the sender address.
     *
     * @return string
