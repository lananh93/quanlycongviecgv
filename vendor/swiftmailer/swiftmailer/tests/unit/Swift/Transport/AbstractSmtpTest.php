...
abstract class Swift_Transport_AbstractSmtpTest extends \SwiftMailerTestCase
{
    ...
    public function testStartSendsHeloToInitiate()
    {
        /* -- RFC 2821, 3.2.
         ...
         require service extensions in the email session being initiated, MAY
    ...
    public function testSuccessfulMailCommand()
    {
        ...
        There are three steps to SMTP email transactions.  The transaction
        ...
        The first step in the procedure is the MAIL command.
            ...
            MAIL FROM:<reverse-path> [SP <email-parameters> ] <CRLF>
    ...
    public function testSuccessfulRcptCommandWith250Response()
    {
     ...
     This step of the procedure can be repeated any number of times.
        ...
        This command is used to identify an individual recipient of the email
        ...
        -- RFC 2821, 4.2.2.
            ...
            250 Requested email action okay, completed
    ...
    public function testRsetIsSentIfNoSuccessfulRecipients()
    {
        ...
        This command specifies that the current email transaction will be
        aborted.  Any stored sender, recipients, and email data MUST be
    ...
    public function testSuccessfulDataCommand()
    {
        ...
        email data indicator to be the message text.

        -- RFC 2821, 4.1.1.4.

        The receiver normally sends a 354 response to DATA, and then treats
        the lines (strings ending in <CRLF> sequences, as described in
        section 2.3.7) following the command as email data from the sender.
        This command causes the email data to be appended to the email data
        buffer.  The email data may contain any of the 128 ASCII character
