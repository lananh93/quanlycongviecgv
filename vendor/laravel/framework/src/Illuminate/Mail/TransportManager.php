...
class TransportManager extends Manager
{
    ...
    protected function createSmtpDriver()
    {
        ...
        // for delivering email such as Sendgrid, Amazon SES, or a custom server
    ...
    {
        $command = $this->app['config']['email']['sendmail'];
    ...
    {
        return $this->app['config']['email.driver'];
    }
    ...
    {
        $this->app['config']['email.driver'] = $name;
    }
}
