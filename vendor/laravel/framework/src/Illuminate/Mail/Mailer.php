...
class Mailer implements MailerContract, MailQueueContract
{
    ...
    public function send($view, array $data, $callback)
    {
        ...
        // be used when sending an e-email. We will extract both of them out here.
        list($view, $plain, $raw) = $this->parseView($view);

        $data['message'] = $message = $this->createMessage();

        // Once we have retrieved the view content for the e-email we will set the body
    ...
    /**
     * Queue a new e-email message for sending.
     *
     * @param  string|array  $view
     * @param  array  $data
     * @param  \Closure|string  $callback
    ...
    /**
     * Queue a new e-email message for sending on the given queue.
     *
     * @param  string  $queue
     * @param  string|array  $view
     * @param  array  $data
    ...
    /**
     * Queue a new e-email message for sending after (n) seconds.
     *
     * @param  int  $delay
     * @param  string|array  $view
     * @param  array  $data
    ...
    /**
     * Queue a new e-email message for sending after (n) seconds on the given queue.
     *
     * @param  string  $queue
     * @param  int  $delay
     * @param  string|array  $view
    ...
    /**
     * Build the callable for a queued e-email job.
     *
     * @param  \Closure|string  $callback
     * @return string
     */
    ...
    /**
     * Handle a queued e-email message job.
     *
    ...
    /**
     * Get the true callable for a queued e-email message.
     *
     * @param  array  $data
