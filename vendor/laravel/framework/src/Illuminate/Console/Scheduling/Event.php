...
class Event
{
    ...
    /**
     * E-email the results of the scheduled operation.
     *
    ...
    public function emailOutputTo($addresses, $onlyIfOutputExists = false)
    {
        if (is_null($this->output) || $this->output == $this->getDefaultOutput()) {
            throw new LogicException('Must direct output to a file in order to e-email results.');
        }
    ...
    /**
     * E-email the results of the scheduled operation if it produces output.
     *
     * @param  array|mixed  $addresses
     * @return $this
     *
    ...
    /**
     * E-email the output of the event to the recipients.
     *
    ...
    /**
     * Get the e-email subject line for output results.
     *
     * @return string
     */
