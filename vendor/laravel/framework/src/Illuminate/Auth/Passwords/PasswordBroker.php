...
class PasswordBroker implements PasswordBrokerContract
{
    ...
    /**
     * The view of the password reset link e-email.
     *
     * @var string
     */
    protected $emailView;
    ...
    /**
     * Send the password reset link via e-email.
     *
    ...
    public function emailResetLink(CanResetPasswordContract $user, $token, Closure $callback = null)
    {
        ...
        // password reminder e-email. We'll pass a "token" variable into the views
