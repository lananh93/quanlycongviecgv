...
<div class="login-box">
  ...
  <?php if( session()->has('status') && !session('status')): ?>
    <div class="box box-solid box-danger">
      <div class="box-header">
        <h3 class="box-title"><?php echo trans('general.Error'); ?></h3>
      </div><!-- /.box-header -->
      <div class="box-body">
  ...
  <div class="login-box-body">
    ...
    <a href="<?php echo route('signup'); ?>" class="text-center">Đăng ký mới</a>
